                        ...
                        <tbody>
                            @forelse ($dsLienHe as $lh)
                                <tr>
                                   ...
                                   <td>
                                     <button class="btn btn-sm btn-info btn-xem-chi-tiet" data-ten="{{ $lh->ten }}"
                                        data-email="{{ $lh->email }}" data-sdt="{{ $lh->so_dien_thoai }}"
                                        data-noidung="{{ $lh->noi_dung }}"
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="max-height: 400px; overflow-y: auto; word-wrap: break-word;"><strong>Nội dung:</strong> <span id="ct-noidung"></span></p>
      </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    buttons.forEach(btn => {
        btn.addEventListener('click', function () {
            ...
            const modal = new bootstrap.Modal(document.getElementById('modalChiTietLienHe'));
            modal.show();
        });
    });
});
