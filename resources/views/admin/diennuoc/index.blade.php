                            ...
                            <form method="POST" action="{{ route('diennuoc.update', $dn->id) }}">
                                ...
                                <td>
                                    @if ($kieuTinhNuoc == 'cong_to')
                                        <input type="number" step="0.1" name="so_m3_nuoc" class="form-control"
                                            value="{{ $dn->so_nuoc }}">
                                    @elseif($kieuTinhNuoc == 'dau_nguoi')
                                        <input type="number" class="form-control" name="so_m3_nuoc" value="{{ $dn->so_nguoi }}"
                                            readonly>
                                    @elseif($kieuTinhNuoc == 'co_dinh')
                                        <input type="text" class="form-control" value="1" name="so_m3_nuoc" readonly>
                                    @endif
                                </td>
